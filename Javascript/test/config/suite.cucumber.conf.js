const defaultTimeoutInterval = process.env.DEBUG ? (60 * 60 * 5000) : 9000000;
...
exports.config = {
    ...
    baseUrl: 'https://www.officeworks.com.au/shop/officeworks/c/technology/',
    ...
    cucumberOpts: {
        ...
        require: ['./test/stepDefinitions/given.js'],   // <string[]> (file/dir) require files before executing features
